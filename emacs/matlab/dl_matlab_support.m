...
%   destination directory DEST 
    ...
    tlcFiles = { 'tlc.el' };
    cedetFiles = { 'cedet-matlab.el' 'semantic-matlab.el' 'semanticdb-matlab.el' 'templates/srecode-matlab.srt' };
    supportFiles = { 'dl_emacs_support.m' 'README' 'Makefile' 'Project.ede' 'INSTALL' 'ChangeLog' 'templates/Project.ede' 'templates/Makefile'};
